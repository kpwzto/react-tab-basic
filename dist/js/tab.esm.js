...
// src/app/components/NavLink.tsx
var NavLink = class extends React4.Component {
  constructor(props) {
    super(props);
  }
  render() {
...
var Tabs = class extends React7.Component {
  constructor(props) {
    super(props);
    const {
      children,
  ...
  render() {
    return /* @__PURE__ */ React7.createElement(TabsContext.Provider, {
      value: {
        tabContextId: this.state.tabContextId,
        setTabContextId: this.setTabContextId
      }
    }, /* @__PURE__ */ React7.createElement(TabsContext.Consumer, null, ({ tabContextId }) => {
      return /* @__PURE__ */ React7.createElement(React7.Fragment, null, /* @__PURE__ */ React7.createElement(Nav_default, __spreadValues({}, this.props), map(this.props.children, (child) => {
        const _a = child.props, { title } = _a, props = __objRest(_a, ["title"]);
        return /* @__PURE__ */ React7.createElement(NavLink_default, __spreadProps(__spreadValues({}, props), {
          isActive: tabContextId === child.props.activeKey ? true : false
        }), title);
      })), /* @__PURE__ */ React7.createElement(TabPanel_default, null, map(this.props.children, (child) => {
        const childProps = __spreadValues({}, child.props);
        delete childProps.title;
        return /* @__PURE__ */ React7.createElement(TabContent_default, __spreadValues({
